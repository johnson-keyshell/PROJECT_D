...
from .services import get_user_payments,get_single_payment,get_payment_status,cancel_payment_service,create_payment
...
async def get_payment_details(
    ...
    try:
        payment = await get_single_payment(payment_id, current_user)
        if not payment:
